...
(function (Highcharts) {
    ...
    const each = Highcharts.each || function (arr, fn) { return arr.forEach(fn); },
        pick = Highcharts.pick || function () {
    ...
    if (Highcharts.getOptions().exporting?.buttons?.contextButton?.menuItems) {
